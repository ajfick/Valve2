...
$sql = "SELECT * FROM Contributions WHERE status='unMatched' AND type='Credit Card' ORDER BY epochDate LIMIT 10";
$results = $conn->query($sql);
$conn->close();
$i = 0;
if($results->num_rows > 0){ // If there are search results
